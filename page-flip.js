  ...
  fn.prototype.buildMarkup = function (mainElement) {
    this._el('#page-flip').element.innerHTML = `
      <div class="pages-container">
        ...
        <div class="page-left">
          <div class="page-grabber" title="Previous Page"> <!-- Need to remove and find a better way -->
        ...
        <div class="page-right">
          <div class="page-middle"></div>
          <div class="page-grabber" title="Next Page"> <!-- Need to remove and find a better way -->
            <div class="page-fold"></div>
          </div>
        </div>
